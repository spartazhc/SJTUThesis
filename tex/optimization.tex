...
\subsection{FFmpeg中AV1的RTP封装实现}
	...
	\begin{figure}[!htp]
		...
		\caption{AV1聚合头部\cite{RTPPayloadFormat}}
...
图\ref{fig:cpu-ana}展示了SVT-AV1编码器的各编码过程所用的CPU时间占比，测试发现，SVT-AV1编码器的CPU密集型任务主要分布在ENCDEC、ME两个编码过程中，其中ENCDEC过程所用的CPU时间占总CPU时间的62\%，ME过程所用的CPU时间占总CPU时间的33\%。
