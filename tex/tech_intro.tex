...
\begin{figure}[!htp]
	...
	\caption{流媒体协议延迟及相关应用场景\cite{StreamingVideoLatency2019}}
...
\paragraph{ISOBMFF} ISO/IEC基本媒体文件格式（ISO/IEC Base Media File Format）定义了基于时间的多媒体文件的通用结构。ISOBMFF用作其他容器格式的基础，如MP4以及CMAF等。ISOBMFF定义于ISO/IEC 14496-12\cite{InformationTechnologyCoding}，AOMedia推出了AV1视频编码的ISOBMFF协议规范\cite{cyrilAV1CodecISO}。
